        ...
        <div className={style.wrapperContainerHome}>
            ...
            <div className={style.wrapperContainerHomeOpstions} >
                <div className={style.wrapperOption}>
                    <select value={'Selecionar Opção'} className={style.select} onChange={e => setKindActivity(e.target.value)}>
                        <option disabled value='Selecionar Opção'>Selecionar Atividade</option>
